...
import 'package:covidcoffee/src/ui/widget/maps/AppBarMaps.dart';
import 'package:covidcoffee/src/utility/FadeAnimation.dart';
...
class _MapsState extends State<Maps> {
  ...
  _setAlamat() async{
    ...
    try{
      ...
      if(mounted){
        setState(() {
          ...
          _wilayah_pengiriman = placemark[0].subAdministrativeArea.toString();
        });
      }
    } catch (e) {
      print(e.toString());
    ...
    print(_alamat);
    SessionManager().setSessionAddress(lat, lng, _alamat, _wilayah_pengiriman);
